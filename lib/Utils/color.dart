...
class color{
  static final colorPrimary = const Color(0xFF2b2f71);
  static final colorPrimaryDark = const Color(0xFF303e9f);
  static final bottomNav = const Color(0xFFFF0000);
  static final upCash = const Color(0xFF508050);
  static final stableCash = const Color(0xFFF2b2f4);
